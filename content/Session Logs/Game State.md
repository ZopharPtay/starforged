...
Nassir "Leight" Okoro has reconnected with Flint at their shop on Paxton Station (R5-14-23).  Flint initially mistook his visit for Cartel business, but the mention of Vuldar "Warden" Wolfe's death broke through.  They've agreed to meet at the Gentleman Loser bar at 18:00 station time to talk properly.

The Hulking Anguish has been tugged from the public pads to Flint's service cradle.  Nassir has gantry access but can't launch without being shunted back to a pad.

Nassir has a few hours to kill before the meeting.  He's nearly broke; buying Flint a beer means skipping meals.

## Sector: The Marigny (Outlands)

**Region:** Outlands (Cartel-controlled frontier)
**Passages:** 2 (to be defined)

### Settlements

| Settlement | Location | Pop | Authority | Projects |
|---|---|---|---|---|
| **Paxton** | Orbital (jungle world) | Thousands | Ineffectual (Cartel is the real law) | Subsistence, Entertainment |
| **Aurora** | Deep Space | Hundreds | Ineffectual | Refuge/safe harbor, Manufacturing |
| **Bulwark** | Deep Space | Hundreds | Tolerant | Manufacturing, Signals/Intel |
...
- **Ship Integrity:** 5
- **Assets:** Courier (1), Shade (1), Starship (1), Vehicle Bay (1)
...
- Flint (Dangerous) - independent mechanic, former Cartel asset who was burned
...
### The Afternoon Gap (optional)
- What does Nassir do with a few hours before 18:00?
- Could rummage the Anguish's hold for something to sell/barter (risk: finding hidden items early)
- Could look for quick odd-job money on the ring

### The Bar Meeting (main scene)
- **Nassir's plan:** Arrive slightly late so Flint is already seated.  Go straight to the bar.  Order Flint a beer and himself a "Well Water" (water with a splash of color; an old joke order for people who can't drink, or can't afford to).  Hope Flint doesn't notice or doesn't call him on it.
